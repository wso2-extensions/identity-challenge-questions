...
public class UserChallengeServiceFactory {

        private static final UserChallengeService SERVICE;

        static {

            ChallengeQuestionManager challengeQuestionManager = ChallengeQuestionServiceHolder
            ...
            SERVICE = new UserChallengeService(challengeQuestionManager);
        }

        public static UserChallengeService getUserChallengeService() {
